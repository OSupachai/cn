...
As a admin
So that I delete a job from “Monkey Banana”.
I want to delete a job that closed off recruit from database.

Background: addmin can delete job from Job Database
